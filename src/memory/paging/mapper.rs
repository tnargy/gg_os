...
impl Mapper {
    ...
    /// `FrameAllocator` as it might need to create a new page table.
    ...
    /// The `FrameAllocator` is used to create the new page tables if needed.
        ...
        A: FrameAllocator,
    {
        ...
        tlb::flush(VirtAddr::from_ptr(unsafe { &page.start_address() }));
