...
impl ActivePageTable {
    ...
    pub fn switch(&mut self, new_table: InactivePageTable) -> InactivePageTable {
        ...
        unsafe {
            let empty = control::Cr3Flags::empty();
            let paddress = PhysAddr::new(new_table.p4_frame.start_address() as u64);
            let pframe = PhysFrame::containing_address(paddress);
            control::Cr3::write(pframe, empty);
        }
        old_table
    }
}
